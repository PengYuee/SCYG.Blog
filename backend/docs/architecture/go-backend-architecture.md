...
Toolchain/dependency baselines are Go 1.25.0, Gin 1.11.0, GORM 1.31.1, Viper 1.20.1, oapi-codegen 2.7.2, and golang-migrate 4.19.0. A pin may change only when its exact version cannot resolve, with official release evidence and an ADR recorded before code uses the replacement.
